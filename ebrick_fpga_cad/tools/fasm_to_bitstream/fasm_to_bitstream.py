    ...
    for feature in fasm_feature_list :
        ...
        if ("=" in feature) :
            ...
            if (len(feature_fields) != 2) :
                error("load_fasm_data() ERROR: wrong number of fields for FASM feature assignment")
            else :
