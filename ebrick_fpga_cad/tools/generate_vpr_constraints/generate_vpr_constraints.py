...
def main():
    ...
    option_parser.add_argument("-constraints_map", help="architecture-specific mapping of constraint pins to FPGA core pins")
    option_parser.add_argument("json_constraints", help="architecture-independent ebrick constraints file")
    option_parser.add_argument("constraints_file_out", help="constraints XML file name")
    ...
    for pin in pin_map :
        ...
        if (errors == 0) :
            if (len(gasket_map) == 0) :
                ...
                cur_partition = generate_partition_xml(pin, pin_map[pin], gasket_map[pin_map[pin]], signal_dir)
