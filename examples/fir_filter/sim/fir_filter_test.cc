...
int main(int argc, char **argv, char **env) {
  ...
  Vfir_filter_test *dut = new Vfir_filter_test;
  ...
  if (flag && 0==strcmp(flag, "+trace")) {
    ...
    VL_PRINTF("Enabling waves into logs/fir_filter_test.vcd...\n");
    tfp = new VerilatedVcdC;
    dut->trace(tfp, 99);  // Trace 99 levels of hierarchy
    Verilated::mkdir("logs");
    tfp->open("logs/fir_filter_test.vcd");  // Open the dump file
  }
#endif
